...
#    {0} --> self.nome, {1}--> self.cognome, {2}--> self.classe_frequentata
        scheda = "Nome: {0},\n Cognome = {1},\n Classe = {2}\n".format(self.__nome, self.cognome, self.classe_frequentata)
        return scheda
...
if __name__ == "__main__":
    ...
    print(studente1._Studente__nome) # stampa l'attributo nome dell'istanza studente1
    print(studente1.cognome) # stampa l'attributo cognome dell'istanza studente1
    print(studente2._Studente__nome) # stampa l'attributo nome dell'istanza studente2
